...
<body>
    <div class="container">
        ...
        <h5 class="form-title">ANNULER UN TRANSFERT D'ARGENT</h5>

        <form id="realTimeForm" class="needs-validation" method="POST" action="{{ route('transfert.annuler') }}" novalidate>
        @csrf  <!-- Protection CSRF obligatoire -->

            <div id="inputs">
            <div class="mb-4">
                <label for="telephone" class="form-label"><b>NUMERO DU DESTINATAIRE</b></label>
            ...
            <div class="mb-4">
                <label for="telephone2" class="form-label"><b>NUMERO DU CLIENT</b></label>
                <input type="tel" id="telephone2" name="telephone2" class="form-control" pattern="[0-9]{9}" value ="{{ old('telephone2') }}" placeholder="7XXXXXXXX" required>
                <div class="invalid-feedback">
                    Le numéro doit contenir exactement 9 chiffres.
                </div>
                <div class="valid-feedback">
            ...
            <div class="btn-group">
                ...
                <a href="{{ route('agent.dashboard') }}" class="btn btn-danger ">ANNULER</a>
            </div>
        </form>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        @if (session('success'))
            Swal.fire({
                ...
                text: 'Vous pouvez verifier votre compte.',
