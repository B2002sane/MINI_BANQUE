...
<body>
    ...
    <div class="container">
        ...
        <h1 class="form-title">CREATION DE COMPTE DISTRIBUTEUR</h1>
       
        <form id="registrationForm" action="{{ route('AddUtilisateur') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
            ...
            <div class="formu">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="date_naissance" name="date_naissance" min="1960-01-01" max="2006-01-01">
                ...
                <div class="buttons">
                    ...
                    <button type="button" class="btn btn-danger"> 
                        <a class="lien" href="{{ route('agent.dashboard') }}"> Annuler</a>
                    </button>
                </div>
            </div>
        </form>
